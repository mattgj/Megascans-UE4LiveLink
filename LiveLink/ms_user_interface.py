...
megascans_fldr = (os.path.join(ms_return_path(), 'megascans', 'ui'))
...
""")
# material_style = material_style.replace("down_arr", os.path.join(megascans_fldr, 'cursor_down.png'))
...
class QBaseButton(QPushButton):
    ...
    def __init__(self, request):
        ...
        self.setIcon( QIcon(QPixmap(os.path.join(megascans_fldr, self.request + '_icon.png'))))
    ...
    def enterEvent(self, event):
        self.setIcon( QIcon(QPixmap(os.path.join(megascans_fldr, self.request + '_hover_icon.png'))))
        self.setIconSize(QSize(22, 22))
...
class QCustomCheckBox(QWidget):
    ...
    def __init__(self, request, checkstate, parent):
        ...
        self.path_ = (os.path.join(megascans_fldr, 'Checked_Black.png'))
        self.request = request
        self.parent = parent
        ...
        QToolTip
{
    ...
    min-height: 30px;
        ...
        self.setWindowIcon(QIcon(os.path.join(megascans_fldr, 'MS_Logo.png')))
        self.setWindowFlags(Qt.FramelessWindowHint)
        ...
        self.logo_.setIcon( QIcon(QPixmap(os.path.join(megascans_fldr, 'MS_Logo.png'))))
